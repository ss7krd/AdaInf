...
centralized = [88.1,85.6,85.1,83.9]
ax.plot(stepX,centralized,c='green',marker="D",markersize=26,ls='-',label="Ekya",fillstyle='full', linewidth = 4)
