...
proposed = [0.005,0.006,0.2,0.22,0.23,0.23,0.3,0.28,0.25,0.31,0.29,0.29,0.28,0.3,0.22,0.24,0.26,0.28,0.21,0.22]
...
ax.plot(stepX,proposed,c='red',marker="x",mew=4,markersize=26,ls='-',label="Person recognition",fillstyle='full', linewidth = 6)
...
static = [0.002,0.002,0.003,0.45,0.5,0.55,0.42,0.44,0.46,0.4,0.5,0.43,0.46,0.5,0.4,0.4,0.52,0.52,0.5,0.44]
ax.plot(stepX, static, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Vehicle recognition", fillstyle = 'full', linewidth = 6)
