...
ax.bar(ind, dummy, width, color='lime', edgecolor='black', label='Without retraining')
...
xvalues = ["Face detection", "Person recognition"]
...
leg = plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.45), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
            fontsize='38', ncol=2, handleheight=1.2, labelspacing=0.0, frameon=False)
