...
proposed_igpr = (np.array([91.3,90.5,88.3,87,93.4]))
...
ax.bar(ind,dummy,width,color=[(1,0.7,0)],edgecolor='black',label="After initial training")
# ax.bar(ind,dummy,width,color='lime',edgecolor='black',label="CSIR")
ax.bar(ind,dummy,width,color='darkgrey',edgecolor='black',label="After first retraining")
...
static_igpr = (np.array([92.8,90.3,89,88.2,94.9]))
...
leg = plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.55), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
            fontsize='48', ncol=1, handleheight=1.5, labelspacing=0.6, frameon=False) 
