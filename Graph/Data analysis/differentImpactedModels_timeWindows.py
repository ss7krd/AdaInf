...
proposed = [0,0,6,7,5,5,6.5,6.5,6.8,6,6.5,6.8,5,7,8,8.2,7,5,6,6.3]
...
static = [0,0,0,14,13,13.5,14.2,16,16.4,17,17.2,14,14.3,15,15.6,16,16,16.2,14,15.5]
ax.plot(stepX, static, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Vehicle recognition", fillstyle = 'full', linewidth = 6)



ax.set_ylabel('Impact of data drift')
