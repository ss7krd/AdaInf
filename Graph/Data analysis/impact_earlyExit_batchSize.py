...
proposed_igpr = (np.array([455,395,379,425]))
...
ax.bar(ind,dummy,width,color=[(1,0.7,0)],edgecolor='black',label="Full version")
# ax.bar(ind,dummy,width,color='lime',edgecolor='black',label="CSIR")
ax.bar(ind,dummy,width,color='darkgrey',edgecolor='black',label="Early-exit version 1")
...
static_igpr = (np.array([390,400,370,360]))
