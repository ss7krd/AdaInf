...
# ax.plot(stepX,np.array(proposed)-14,c='red',marker="x",mew=4,markersize=26,ls='-',label="Early-exit version (with incremental retraining)",fillstyle='full', linewidth = 6)
...
ekya = [34,34,35,36,35,37,37,37.3,36,35,35,35,36,36.4,36,35.1,35.1,36,36,35]
ax.plot(stepX, 100-(np.array(ekya)-14)*2, c = 'green', marker = 'D', markersize = 26, ls = '-', label = "Ekya", fillstyle = 'full', linewidth = 6)
...
ax.set_ylabel('Inference requests')
...
ax.set_position([box.x0 + box.width*0.01, box.y0 + box.height*0.07, box.width, box.height*0.8])
