...
static = [99,99,99.6,99,90.3,90,89.5,90.3,91,89.4,90.6,91,90,90.1,90.6,91.2,89.4,90.3,89.6,89.8]
...
ekya = [34,34.5,37,35,35.3,36.4,36.9,37,36.5,35,34,37,36.5,36.7,34.9,34.5,35,36.7,36,37]
...
ax.set_ylabel('Retraining finish time (sec)')
...
ax.set_position([box.x0 + box.width*0.01, box.y0 + box.height*0.01, box.width, box.height*0.8])
#bbox_to_anchor=(0.5, 1.6)
leg = plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.50), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
