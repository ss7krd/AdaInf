...
proposed = [99,99.6,99,99,99,99,99.7,99,99.6,99,99,99,99,99,99.5,99.7,99,99.6,99.4,99.5]
...
ax.plot(stepX,proposed,c='red',marker="x",mew=4,markersize=26,ls='-',label="With retraining",fillstyle='full', linewidth = 6)
...
static = [99,99.6,99,99,99,99,99.7,99,99.6,99,99,99,99,99,99.5,99.7,99,99.6,99.4,99.5]
ax.plot(stepX, static, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Without retraining", fillstyle = 'none', linewidth = 6)
...
ax.set_position([box.x0 + box.width*0.04, box.y0 + box.height*0.09, box.width, box.height*0.75])
