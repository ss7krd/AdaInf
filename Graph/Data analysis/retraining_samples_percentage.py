...
proposed = [32,30,29,30,31.3,33,34,34.2,34.5,34.3,34,34,32,30,30,30.3,32,31,32,32]
...
ax.plot(stepX,np.array(proposed)+60,c='red',marker="x",mew=4,markersize=26,ls='-',label="Early-exit version (with incremental retraining)",fillstyle='full', linewidth = 6)
...
ekya = [33,33,35,33,35,36.1,36.1,36.1,36.3,35,35,36.5,36.5,36.5,34.5,34.5,34.5,36,36,36]
ax.plot(stepX, np.array(ekya)+60, c = 'green', marker = 'D', markersize = 26, ls = '-', label = "Ekya", fillstyle = 'full', linewidth = 6)
...
ax.set_ylabel('Retraining samples')
...
ax.set_position([box.x0 + box.width*0.05, box.y0 + box.height*0.01, box.width, box.height*0.8])
