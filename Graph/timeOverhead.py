...
ax.bar(ind, dummy_0, width, color='pink', hatch = '-', edgecolor='black', label = 'DAG creation overhead')
ax.bar(ind, dummy_1, width, color = 'lime', hatch = '//', edgecolor = 'black', bottom= dummy_0, label='Time and space multiplexing overhead')
