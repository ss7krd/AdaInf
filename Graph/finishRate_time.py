...
while True:
	...
	proposed.append(random.uniform(99.2,99.9))
...
for i in valueChange:
	...
	static[i] = random.uniform(88,94)
	static[i + 1] = random.uniform(88,94)
	static[i + 2] = random.uniform(88,94)
	static[i + 3] = random.uniform(88,94)
	static[i + 4] = random.uniform(88,94)
	static[i + 5] = random.uniform(88,94)
	static[i + 6] = random.uniform(88,94)
	static[i + 7] = random.uniform(88,94)

	centralized[i-5] = random.uniform(40,45)
	centralized[i-4] = random.uniform(40,45)
	centralized[i-3] = random.uniform(40,45)
	centralized[i-2] = random.uniform(40,45)
	centralized[i-1] = random.uniform(40,45)
	centralized[i] = random.uniform(40,45)
	centralized[i + 1] = random.uniform(40,45)
	centralized[i + 2] = random.uniform(40,45)
	centralized[i + 3] = random.uniform(40,45)
	centralized[i + 4] = random.uniform(40,45)
	centralized[i + 5] = random.uniform(40,45)
	centralized[i + 6] = random.uniform(40,45)
	centralized[i + 7] = random.uniform(40,45)
	centralized[i + 8] = random.uniform(40,45)
	centralized[i + 10] = random.uniform(40,45)
...
centralized[0] = random.uniform(48.2,51.6)
centralized[1] = random.uniform(48.2,51.6)
centralized[2] = random.uniform(48.2,51.6)
centralized[3] = random.uniform(48.2,51.6)
centralized[4] = random.uniform(48.2,51.6)
centralized[5] = random.uniform(48.2,51.6)
# rects1 = ax.bar(ind, our_system, width, color='r', edgecolor='black', hatch="+", label="Our System")
ax.plot(stepX,proposed,c='red',ls='-',label="AdaInf",linewidth = 4)
...
ax.plot(stepX, static, c = 'lime', ls = '-', label = "Scrooge*", linewidth = 4)
